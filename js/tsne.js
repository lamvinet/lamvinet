...
(function(global) {
  ...
  tSNE.prototype = {
    ...
    initDataRaw: function(X, Y) {
      ...
      this.initSolution(Y); // refresh this
    },
    ...
    initSolution: function(Y) {
      // generate random solution to t-SNE
      if (typeof Y === 'undefined') this.Y = randn2d(this.N, this.dim); // the solution;
      else this.Y = Y;
